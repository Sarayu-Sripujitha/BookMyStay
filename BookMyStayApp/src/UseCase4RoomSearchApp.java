...
public class UseCase4RoomSearchApp {
    public static void main(String[] args) {
        ...
        rooms.put("Single", new SingleRoom(1, 250, 100.0));
        rooms.put("Double", new DoubleRoom(2, 350, 150.0));
        rooms.put("Suite", new SuiteRoom(3, 500, 300.0));
